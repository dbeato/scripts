...
# unifi_ssl_import.sh
# Unifi NVR Controller SSL Certificate Import Script for Unix/Linux Systems
...
# REQUIREMENTS
# 1) Assumes you have a Unifi NVR Controller installed and running on your system.
...
UNIFI_DIR=/usr/lib/unifi-video/
JAVA_DIR=${UNIFI_DIR}
KEYSTORE=${UNIFI_DIR}/data/keystore

# Uncomment following three lines for Debian/Ubuntu
#UNIFI_DIR=/usr/lib/unifi-video
#JAVA_DIR=/usr/lib/unifi-video
#KEYSTORE=${UNIFI_DIR}/data/keystore
...
printf "\nStarting Unifi NVR Controller SSL Import...\n"
...
# Stop the Unifi NVR Controller
printf "\nStopping Unifi NVR Controller...\n"
...
# Restart the Unifi NVR Controller to pick up the updated keystore
printf "\nRestarting Unifi NVR Controller to apply new Let's Encrypt SSL certificate...\n"
